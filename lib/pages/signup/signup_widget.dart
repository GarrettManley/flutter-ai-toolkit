                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          wrapWithModel(
                            model: _model.inputPasswordModel1,
                            updateCallback: () => setState(() {}),
                            child: InputPasswordWidget(),
                          ),
                          wrapWithModel(
                            model: _model.inputPasswordModel2,
                            updateCallback: () => setState(() {}),
                            child: InputPasswordWidget(),
                          ),
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.inputPasswordModel1
                                        .passwordController.text !=
                                    _model.inputPasswordModel2
                                        .passwordController.text) {
                                ...
                                final user =
                                  ...
                                  context,
                                  _model.inputEmailModel.emailAddressController
                                      .text,
                                  _model.inputPasswordModel1.passwordController
                                      .text,
                                );
                                if (user == null) {
                                  return;
